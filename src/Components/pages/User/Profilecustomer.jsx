...
export default function Profilecustomer() {
  ...
  return (
    <div className="bg-white">
      <div className="md:max-w-7xl mx-auto pb-3 px-4 md:px-8 lg:px-16">
        {/* Header */}
        ...
        {/* General Section */}
        <div className="mt-4">
          <h4 className="text-black text-lg font-semibold">General</h4>
        ...
        <div className="mt-2 cursor-pointer">
          <h4 className="text-black text-lg font-semibold">Help & Support</h4>
          <div className="bg-white">
            <SectionItem
              icon={<CiGlobe />}
              title="Languages"
